...
wn.title("Snake Game")
wn.bgcolor("blue")
wn.bgpic(f"{p}/finaldest.gif")
# the width and height can be put as user's choice
wn.setup(width=1900, height=1080)
wn.tracer(0)

# head of the snake
head = turtle.Turtle()
wn.register_shape (f"{p}/fox.gif")
head.shape(f"{p}/fox.gif")
head.color("white")
head.penup()
head.goto(0, 0)
head.direction = "Stop"
...
# food in the game
food = turtle.Turtle()
wn.register_shape (f"{p}/sakurai.gif")
colors = random.choice(['red', 'green', 'black'])
shapes = random.choice(['square', 'triangle', 'circle'])
food.speed(0)
food.shape(f"{p}/sakurai.gif")
food.color(colors)
food.penup()
food.goto(0, 100)
